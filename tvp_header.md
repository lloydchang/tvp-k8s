...
A TVP is a careful balance between keeping the platform small and ensuring that the platform is helping to accelerate and simplify software delivery for teams building on the platform. The concept was introduced by Matthew Skelton and Manuel Pais, co-authors of the book Team Topologies.
...
This README provides a visual overview of the system architecture using various diagrams.
