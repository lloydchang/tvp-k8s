    ...
    with patch("pathlib.Path.exists", return_value=True), \
        ...
        async def test():
            try:
                ...
                # Also accept an HTTPException with 'nothing to commit' in it
...
def test_lines_341_to_346_thread_creation_errors():
    """Test lines 341-346 for thread creation errors in start_reconciliation_thread"""
    ...
    try:
        # Set thread to None to force creation path
        gitops.reconciliation_thread = None
        
        # Test with RuntimeError (lines 341-345)
        with patch("threading.Thread") as mock_thread:
            # Make thread constructor raise RuntimeError
        ...
        # Reset thread to None again
        gitops.reconciliation_thread = None
        
        # Test with general Exception (line 346)
        with patch("threading.Thread") as mock_thread:
            # Make thread constructor raise a different exception type
